...
public class interfaz extends javax.swing.JFrame {
    ...
    List<palabraReservada> tokenslist;
    public interfaz() {
        initComponents();
    }
    ...
    */
    ...
    public void probarLexerFile() throws IOException{
        int contIDs=0;
        tokenslist = new LinkedList<palabraReservada>();
        ...
        while (true){
            ...
            if (token == null){
                for(int i=0;i<tokenslist.size();i++){
                    System.out.println(tokenslist.get(i).palabraReservada);
                }
            ...
            switch (token){
                case PALABRARESERVADA:
                    ...
                    break;
                default:
                    resultado=resultado+ " TOKEN NO RECONOCIDO LINEA: "+lexer.yyline+" ";
                    jTextField2.setText(resultado);
                    return;
            }
    }
    ...
    public void tablaResultado(){
        ...
        for(int i =0; i<tokenslist.size();i++){
            matriz[i][0] = tokenslist.get(i).palabraReservada;
        }
